  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        textDirection: TextDirection.rtl, // دي هتعكس كل حاجة في الـ Row
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment
                  .end, // الكلام كله يبقى ناحية الشمال بعد الانعكاس
              children: [
                Text(
                  mainText,
                ...
                Row(
                  ...
                  textDirection: TextDirection.rtl, // عكس ترتيب الأزرار
                  children: actions
                      .map(
                        (action) => Padding(
