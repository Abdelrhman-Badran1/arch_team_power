...
class NotesRepoImpl implements NotesRepo  {
  ...
  @override
  Future<Either<Failure, NoteEntity>> createNote({required String title, required String description}) async {
   try {
    final createNote= await remoteDataSource.createNote(title: title, description: description);
  ...
  @override
  Future<Either<Failure, NoteEntity>> updateNote({required String title, required String description,required num id}) async {
    try {
      final updateNote= await remoteDataSource.updateNote(title: title, description: description, id: id);
