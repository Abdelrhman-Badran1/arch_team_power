...
import 'package:arch_team_power/features/auth_screen/presentation/view/widget/change_password_dialog.dart';
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          Image.asset('assets/image/new_password_avatar.png'),
